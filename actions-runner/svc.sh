...
SVC_NAME="actions.runner.kaiser-kitchen-loyalty-point-backend.Rajwinders-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (kaiser-kitchen-loyalty-point-backend.Rajwinders-MacBook-Air)"
